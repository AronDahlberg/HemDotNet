...
{
    /// <inheritdoc />
    public partial class AlsoMunicipalitiesForAgency : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RealEstateAgencyId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RealEstateAgencyName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ...
                    RealEstateAgencyMunicipality = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RealEstateAgency = table.Column<int>(type: "int", nullable: true),
